...
File names are not null-terminated (`\0`). For each directory block, if
the last file name doesn't reach up to the end of the block, the remaining
bytes must be filled by `0x00`.
