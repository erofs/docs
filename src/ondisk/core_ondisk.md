...
| 0x20   | 4    | `u32`  | `fixed_nsec`             | Nanoseconds component of `epoch` |
| 0x24   | 4    | `u32`  | `blocks_lo`              | Low 32 bits of total block count; see {ref}`block-count-encoding` |
...
| 0x54   | 2    | `u16`  | `compression_enable`     | 0 for non-compressed images, any non-zero value for compressed images |
...
| 0x5B   | 17   | `u8[]` | `reserved`               | Feature-specific; not described in core format |
| 0x6C   | 4    | `u32`  | `build_time`             | Auxiliary 32-bit creation timestamp |
| 0x70   | 8    | `u64`  | `rootnid_8b`             | Root directory NID (64-bit); see {ref}`root-nid-encoding` |
...
| 0x0C   | 4    | `u32` | `i_mtime`        | Modification time, seconds relative to `epoch` |
